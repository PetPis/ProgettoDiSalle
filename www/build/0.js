...
var CategoriePage = /** @class */ (function () {
            ...
            buttons: [
                {
                    text: 'Si',
                    handler: function () {
                        _this.movimentoService.findByCategoriaId(c.id).subscribe(function (data) {
                            if (data) {
                                _this.error();
                            }
                            else {
                                _this.categoriaService.deleteCategoria(c).subscribe(function () {
    ...
    CategoriePage.prototype.error = function () {
