...
import savemymoney.common.spring.security.JWTAuthenticationEntryPoint;
import savemymoney.common.spring.security.JWTAuthenticationTokenFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.csrf().disable().exceptionHandling().authenticationEntryPoint(unauthorizedHandler).and()
				...
				.antMatchers("/api/movimenti/**","/api/categorie/**").authenticated()
				.antMatchers("/famiglia//**").authenticated()
